import { Bell, Bot, Container, Database, GitBranch, Info, Key, Library, Mic, MonitorPlay, Palette, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'skills', labelKey: 'mainTabs.skills', icon: Library },
