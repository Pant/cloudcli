...
export type SettingsMainTab = 'agents' | 'skills' | 'appearance' | 'git' | 'api' | 'voice' | 'browser' | 'notifications' | 'plugins' | 'cache' | 'docker-management' | 'about';
export type AgentProvider = LLMProvider;
export type AgentCategory = 'account' | 'permissions' | 'mcp' | 'skills' | 'agent-config';
